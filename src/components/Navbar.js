    ...
    return (
        <nav>
            <BrowserRouter>
                ...
                <div id='mobile'>
                <Link><i onClick={()=>{setBardisplay(!bardisplay)}} className={bardisplay? "fa fa-bars fa-2x" :"fa fa-times fa-2x"} aria-hidden="true"></i></Link>
                </div>
            </BrowserRouter>
        </nav >
    );
